...
export const metadata: Metadata = {
  ...
  description:
    "Loja online de produtos personalizados em impressão 3D da iDeia & Art.",
}
          ...
          <div className="flex flex-col min-h-screen">
            ...
            <header className="w-full border-b bg-white/80 backdrop-blur">
              <div className="max-w-6xl mx-auto flex items-center justify-between gap-4 py-3 px-4">
                ...
                <nav className="flex items-center gap-4 text-sm">
                  ...
                  <Link href="/produtos" className="hover:text-zinc-800">
                    Produtos
                  </Link>
                  <Link href="/carrinho" className="hover:text-zinc-800">
                    Carrinho
                  </Link>
                  <Link href="/contato" className="hover:text-zinc-800">
                    Contato
                  </Link>
                </nav>
              </div>
            ...
            <footer className="border-t mt-8">
              <div className="max-w-6xl mx-auto px-4 py-4 text-xs text-zinc-500 flex items-center justify-between">
                <span>
                  © {new Date().getFullYear()} iDeia & Art. Todos os direitos
                  reservados.
                </span>
                <span className="hidden sm:inline">
                  Produzido com Next.js & Tailwind.
                </span>
              </div>
            </footer>
          </div>
