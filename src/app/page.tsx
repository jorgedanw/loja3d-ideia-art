      ...
      <div className="grid gap-8 md:grid-cols-[2fr,1.2fr] items-center">
        <div>
          ...
          <p className="text-zinc-600 mb-4">
            ...
            Uma experiência simples, transparente e com comunicação clara sobre prazos e custos.
          </p>
          <ul className="text-sm text-zinc-700 space-y-1 mb-6">
            ...
            <li>• Pagamentos via PIX e cartão para todo o Brasil</li>
            <li>• Frete com cálculo por CEP e prazo de produção incluso</li>
          </ul>
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs text-zinc-500 text-center">
            O selo será usado em produtos, badges de qualidade e páginas internas para reforçar a marca.
          </p>
        </div>
      </div>
    </section>
